...
Just as an object belongs to a class in object-oriented programming, a coroutine belongs to a **Coroutine-Traits** in coroutine programming.
...
Note that, `promise_type` class (or the **Coroutine-traits**) is defined by the programmer, but is instantiated and used by the compiler automatically, see [Compiler Transformation](#Compiler-Transformation) below.
